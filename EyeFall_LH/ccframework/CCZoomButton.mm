...
- (void) draw 
{
	...
	[mButtonLabel setPosition:ccp(x, winSize.height - y - 10 / SCALE_SCREEN_HEIGHT)];
	[mSprite setScale: mfZoomScale * mfScaleFactor]; 
	[mButtonLabel setScale: mfZoomScale * mfScaleFactor];
	...
	{
		[mSelSprite setScale:mfZoomScale * mfScaleFactor];
		[mSelSprite visit];
	}
	else 
	{
